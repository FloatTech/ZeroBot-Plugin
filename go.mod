...
require (
	github.com/FloatTech/AnimeAPI v1.3.0-beta4
	github.com/FloatTech/sqlite v0.1.0
	github.com/FloatTech/zbputils v1.3.0-beta4
	...
	github.com/wdvxdr1123/ZeroBot v1.4.2-0.20220210154203-951a09340768
