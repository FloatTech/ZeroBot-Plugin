...
require (
	github.com/FloatTech/AnimeAPI v1.2.4-beta4
	github.com/FloatTech/zbputils v1.2.4-beta4
	...
	github.com/wdvxdr1123/ZeroBot v1.4.2-0.20220117142919-4ad1916ac4c8
