...
func init() {
	...
	url := flag.String("u", "ws://127.0.0.1:1025", "Set Url of WSClient.")
	// 默认昵称
	...
	// 通过代码写死的方式添加主人账号
	// sus = append(sus, 2393905906)
	// sus = append(sus, 1763460065)
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana}, "GDY", "atri", "亚托莉", "アトリ"),
