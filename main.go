...
func init() {
	...
	url := flag.String("u", "ws://127.0.0.1:7778", "Set Url of WSClient.")
	// 默认昵称
	adana := flag.String("n", "AL-1S", "Set default nickname.")
	...
	// 通过代码写死的方式添加主人账号
	 sus = append(sus, 2856711804)
	 sus = append(sus, 1256665310)
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana}, "アリス", "爱丽丝"),
